...
if (!fechaNacimiento.value) {
    ...
    if (validation) {
        ...
        // Guardar en localStorage. Hasta que decida borrarlos, el sesionstorage guara hasta que termina la sesion o cierra el navegador?
        localStorage.setItem('formData', JSON.stringify(formData)) //setItem es el metodo y lo que hace es escribir en el objeto localTorage 
        //el primer formData no es el de la constante, es el nombre con el que se va a guardar en localStoraage (key), puede ser cualquier nombre
        //el segundo formData es el de la constante q se va a transformar en texo plano y se va a guardar
